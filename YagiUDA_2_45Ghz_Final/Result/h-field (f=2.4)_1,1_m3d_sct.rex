...
<MetaResultFile version="20210114" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SimulationProperties fieldname="surface current (f=2.4) [1]" frequency="2.4000000953674316" encoded_unit="&amp;U:A^1.:m^-1" fieldtype="Surface current" fieldscaling="PEAK" dB_Amplitude="20"/>
